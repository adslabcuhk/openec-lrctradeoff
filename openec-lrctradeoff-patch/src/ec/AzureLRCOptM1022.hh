#ifndef __AZURE_LRC_OPTM_1022_HH__
#define __AZURE_LRC_OPTM_1022_HH__
...
class AzureLRCOptM1022 : public ECBase
{
private:
    int _l;
    int _g;
...
public:
    AzureLRCOptM1022(int n, int k, int w, int opt, vector<string> param);
    ~AzureLRCOptM1022();
...
#endif // __AZURE_LRC_OPTM_1022_HH__