...
class StripedBlockReconstructor extends StripedReconstructor
  ...
  public void run() {
    try {
      ...
      System.out.println("KY::StripedBlockReconstructor.blockReconstructTime: " + blockReconstructTime);
      ...
      System.out.println("KY::StripedBlockReconstructor.blockRepairTime: " + blockRepairTime);
  ...
  void reconstruct() throws IOException {
    ...
    while (getPositionInBlock() < getMaxTargetLength()) {
      ...
      // System.out.println("KY::StripedBlockReconstructor.reconstruct.readTime: " + readTime);
 
      // long decodeTime = decodeEnd - readEnd;
      // System.out.println("KY::StripedBlockReconstructor.reconstruct.decodeTime: " + decodeTime);
 
      // long writeTime = writeEnd - decodeEnd;
      // System.out.println("KY::StripedBlockReconstructor.reconstruct.writeTime: " + writeTime);
 
      // long RNDTime = decodeEnd - start;
      // System.out.println("KY::StripedBlockReconstructor.reconstruct.RNDTime: " + RNDTime);
 
      // long reconstructTime = writeEnd - start;
      // System.out.println("KY::StripedBlockReconstructor.reconstruct.reconstructTime: " + reconstructTime);
    ...
    System.out.println("KY::StripedBlockReconstructor.reconstruct.RTime: " + RTime);
    System.out.println("KY::StripedBlockReconstructor.reconstruct.DTime: " + DTime);
    System.out.println("KY::StripedBlockReconstructor.reconstruct.WTime: " + WTime);
    System.out.println("KY::StripedBlockReconstructor.reconstruct.RDTime: " + RDTime);
    System.out.println("KY::StripedBlockReconstructor.reconstruct.RDWTime: " + RDWTime);
  }
